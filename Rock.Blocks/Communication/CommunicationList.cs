...
namespace Rock.Blocks.Communication
{
    ...
    public class CommunicationList : RockBlockType
    {
        ...
        public BlockActionResult GetGridData()
        {
            ...
            // Default to the last 6 months if a null/invalid range or a range > 180 days was selected.
            ...
            //if ( !daysBetween.HasValue || daysBetween > 180 )
            //{
            //    sendDateRange = defaultSlidingDateRange.ToActualDateRange();
            //    sendDateTimeStart = sendDateRange.Start;
            //    sendDateTimeEnd = sendDateRange.End;

            //    // Set the individual's person preferences to match.
            //    BlockPersonPreferences.SetValue( PreferenceKey.FilterSendDateRange, defaultSlidingDateRange.ToDelimitedSlidingDateRangeOrNull() );
...
;WITH CommunicationAggregate AS (
    SELECT c.[Id]
        ...
        , ISNULL(SUM(CASE WHEN cr.[CausedUnsubscribe] = 1 THEN 1 END), 0) AS [UnsubscribedCount]
        , CASE
